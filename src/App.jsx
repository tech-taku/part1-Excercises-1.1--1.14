...
<>
  ...
  <table>
    <tbody>
      <tr>
        <td>Good</td>
        <td><Content count={good} /></td>
      </tr>
      <tr>
        <td>Neutral</td>
        <td><Content count={neutral} /></td>
      </tr>
      <tr>
        <td>Bad</td>
        <td><Content count={bad} /></td>
      </tr>
      <tr>
        <td>All</td>
        <td><Content count={total} /></td>
      </tr>
      <tr>
        <td>Average</td>
        <td><Content count={average} /></td>
      </tr>
      <tr>
        <td>Positive</td>
        <td><Positive selected={selected} good={good} neutral={neutral} bad={bad} /></td>
      </tr>
    </tbody>
  </table>
</>
